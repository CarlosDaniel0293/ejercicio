            ...
            <div class="card">
                ...
                <form class="p-4 bg-dark text-light" method="POST" action="editarProceso.php">
                    ...
                    <div class="mb-3">
                        ...
                        value="<?php echo $empleados->celular; ?>">
                    </div>
                    <div class="d-grid">
                        <input type="hidden" name="codigo" value="<?php echo $empleados->id; ?>">
